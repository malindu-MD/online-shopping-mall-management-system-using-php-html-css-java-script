    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            if(isset($_POST['psearch'])){
             $searchword=$_POST['psearch'];   
            
            $product_query="SELECT * FROM product p,category c where p.category_id=c.category_id AND (p.p_name LIKE '%$searchword%' OR p.p_title LIKE '%$searchword%' OR p.p_description LIKE '%$searchword%' OR c.category_name LIKE '%$searchword%' )";
            $product_query_run=mysqli_query($con,$product_query);
            $resultcheck=mysqli_num_rows($product_query_run);
            if($resultcheck>0){
                ...
                while($row=mysqli_fetch_assoc($product_query_run)){
                  ...
                  echo  '<i class="fa fa-star"></i>
                   ...
                   echo '<center>We are sorry. We cannot find any matches for your search term.</center>';
            }
